		...
		<section class="container mt-5">
			...
			<table class="table mt-5">
				...
				<c:forEach var="pDto" items="${requestScope.pDtos}">
					<tr>
						<td><input type="checkbox" name="chk" value="${pDto.pNum}"/></td>
						<td>
						...
						<td>${pDto.pQty} 개</td>
						<td>${pDto.price} 원</td>
						<td><fmt:formatNumber type="Number" value="${pDto.totPrice}"/>원<br/>
					...
					<tr>
						<form action ="${ctx}/orderDelete.do" name="cartForm" method="post">
